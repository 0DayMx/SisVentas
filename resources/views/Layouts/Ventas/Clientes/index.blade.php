...
<div class="table-responsive">
	 ...
	 <table id="index_clientes" class="table table-hover table-striped-index table-striped-index table-condensed">
        ...
        <tbody class="table-body-index">
            ...
            @foreach($clientes as $dato)
                <tr>
                    ...
                    <td>
                        <a href="{!! url('clientes/'.$dato->id.'/edit') !!}" 
                            class="btn btn-xs btn-flat btn-warning"
                            data-toggle="tooltip" 
                            data-placement="top" 
                            title="Modificar el cliente {!! $dato->razon_social !!}">
                            <i class="glyphicon glyphicon-edit"></i>
                        </a>

                        <a href="{!! url('clientes/'.$dato->id) !!}" 
                            class="btn btn-xs btn-flat btn-info"
                            data-toggle="tooltip" 
                            data-placement="top" 
                            title="Detalle del cliente {!! $dato->razon_social !!}">
                            <i class="glyphicon glyphicon-info-sign"></i>
                        </a>

                        <a href="{!! url('clientes/'.$dato->id.'/destroy') !!}" 
                            class="btn btn-xs btn-flat btn-danger"
                            data-toggle="tooltip" 
                            data-placement="top" 
                            title="Eliminar al cliente {!! $dato->razon_social !!}"
                            onclick="return confirm('¿Seguro de eliminar al cliente {!! $dato->razon_social !!} ?')">
